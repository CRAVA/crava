                       ...
                       bool                         & failed)
{
  ...
  { // Require this density for wavelet estimation
    ...
    TaskList::addTask("Increase the number of layers to improve the quality of the wavelet estimation.\n   The minimum sampling density is "+NRLib::ToString(timeSimbox->getdz())+", and it should be lower than 4.0.\n   To obtain the desired density, the number of layers should be at least "+NRLib::ToString(timeSimbox->GetLZ()/4)); 
  }
