...
SegY::readHeader(FILE * file, char * buffer, char * b2)
{
  ...
  if(buffer[0] == 'Ã' && buffer[1] == '@' && buffer[2] == 'ñ' 
    && buffer[80] == 'Ã' && buffer[160] == 'Ã')
  {
...
{
  sprintf(&(ebcdicH[0]),  "Ã@ñ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[80]), "Ã@ò@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[160]),"Ã@ó@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[240]),"Ã@ô@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[320]),"Ã@õ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[400]),"Ã@ö@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[480]),"Ã@÷@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[560]),"Ã@ø@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[640]),"Ã@ù@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[720]),"Ãñð@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[800]),"Ãññ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[880]),"Ãñò@@@@@@@@@ãÈÉâ@âÅÇè@ÆÉÓÅ@æÁâ@æÙÉããÅÕ@Âè@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[960]),"Ãñó@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1040]),"Ãñô@@@@@@@@@ãÈÅ@ÃÙÁåÁ@×ÙÖÇÙÁÔ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1120]),"Ãñõ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1200]),"Ãñö@@@@@@@@@ÄÅåÅÓÖ×ÅÄ@Âè@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1280]),"Ãñ÷@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1360]),"Ãñø@@@@@@@@@ÙÁÇÕÁÙ@ÈÁäÇÅ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1440]),"Ãñù@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1520]),"Ãòð@@@@@@@@@ÁÕÕÅ@ÙÁÕÄÉ@âèåÅÙâåÅÅÕ@@@@@@@@@@@ÁÕÄ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1600]),"Ãòñ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1680]),"Ãòò@@@@@@@@@ÖÄÄ@ÒÖÓÂÑÖÙÕâÅÕ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1760]),"Ãòó@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1840]),"Ãòô@@@@@@@@@Áã@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[1920]),"Ãòõ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2000]),"Ãòö@@@@@@@@@ãÈÅ@ÕÖÙæÅÇÉÁÕ@ÃÖÔ×äãÉÕÇ@ÃÅÕãÅÙ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2080]),"Ãò÷@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2160]),"Ãòø@@@@@@@@@òððó@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2240]),"Ãòù@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2320]),"Ãóð@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2400]),"Ãóñ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2480]),"Ãóò@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2560]),"Ãóó@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2640]),"Ãóô@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2720]),"Ãóõ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2800]),"Ãóö@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2880]),"Ãó÷@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[2960]),"Ãóø@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[3040]),"Ãóù@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  sprintf(&(ebcdicH[3120]),"Ãôð@ÅÕÄ@ÅÂÃÄÉÃ@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
  ebcdicH[3199]='@';
}
