...
extern "C"
{
  ...
  void 
    pb_Ibm2Ieee  (void  *src, float *dsT, int nel );

  void 
    pb_Ieee2Ibm  (void  *src, float *dsT, int nel );

#ifdef __cplusplus
}
#endif

/* BinaryHeader    : Binary header commom for both Charisam and Seisworks
the header is  copied from some  code developed at Colorado School of Mines, 1995. 
*/
...
/*  
**  The (Seisworks?) trace header below is copied from some 
**  code developed at Colorado School of Mines, 1995. 
**
*/
...
{	
  ...
  int  sx;	/* X source coordinate byte 73*/

  int  sy;	/* Y source coordinate byte 77*/

  float  gx;	/* X group coordinate */

  float  gy;	/* Y group coordinate */
  ...
  short unass[5];	/* unassigned--NOTE: last entry causes 
