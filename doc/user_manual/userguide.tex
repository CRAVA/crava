...
The command \kw{kriging-to-wells}\kwindex{kriging-to-wells} can be used to kriege realisations to well data. By default, this is done if not the \kw{simulation}\kwindex{simulation} command is used.
