...
\subparagraph{\hbracket{number-of-layers}} \rnewkw{number-of-layers}{interval-number-of-layers}
 \slist
   \item \Description Number of layers for the interval
   \item \Argument Int
   \item \Default Use resolution from seismic data.
 \elist
...
\subsubparagraph{\hbracket{location-xl}}\newkw{location-xl}
 ...
 \subsubparagraph{\hbracket{location-start-time}}\newkw{location-start-time}
 \slist
   \item \Description The byte location for the segy start time in the trace header.
   \item \Argument Integer
   \item \Default
 \elist
...
\subparagraph{\hbracket{segy-start-time}}\rnewkw{segy-start-time}{segy-start-time2}
 \slist
   \item \Description Offset value used for the writing segy cubes
   \item \Argument value
   \item \Default Taken from input segy cubes, either from \kw{segy-start-time} under \kw{survey} or read from first segy cube. Mostly relevant if forward mode or estimation mode without segy seismic.
 \elist
...
\subparagraph{\hbracket{fourier-residuals}}\newkw{fourier-residuals}
 \slist
   \item \Description Residuals computed in the actual inversion. Will not add up to original seismic data when combined with synthetic seismic, due to some filtering and numerical imprecision. These are written per interval if \kw{multiple-intervals} is used.
   \item \Argument 'yes' or 'no'
   \item \Default 'no'
\elist
...
\slist
   \item \Description Surfaces are written on the same format at output grids.
	If this is set to 'yes' then all surfaces will also be written on irap classic ascii-format.
   \item \Argument yes or no
   \item \Default no
\elist
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 \slist
   \item \Description Global start time for segy cubes. This is used if no individual time is given for a segy-cube. Output segy cubes will be written with this offset value.
   \item \Argument Value
   \item \Default Taken from the segy cube of the first angle. If there are no segy cubes, the offset value will be taken from the top of the inversion/estimation interval.
 \elist
...
\subparagraph{\hbracket{location-start-time}}\rnewkw{location-start-time}{location-start-time2}
 \slist
   \item \Description The byte location for the segy start time in the trace header.
   \item \Argument Integer
   \item \Default
...
\subsubsection{\hbracket{top-surface}}\rnewkw{top-surface}{top-surface3}
 \slist
   \item \Description File name for standard surface file, or a constant value, giving the top of the time interval used for wavelet estimation.
   \item \Argument Elements controlling the top surface.
   \item \Default
 \elist
  
\paragraph{\hbracket{time-file}}\rnewkw{time-file}{time-file3}
 \slist
   \item \Description File name for standard surface file giving the top of the time interval used for wavelet estimation. This or \rkw{time-value}{time-value3} must be given.
   \item \Argument File name
   \item \Default
 \elist

\paragraph{\hbracket{time-value}}\rnewkw{time-value}{time-value3}
 \slist
   \item \Description Value giving the top time used the wavelet estimation. This or \rkw{time-file}{time-file3} must be given.
   \item \Argument Value (ms)
   \item \Default
 \elist 

\subsubsection{\hbracket{base-surface}}\rnewkw{base-surface}{base-surface3}
 \slist
   \item \Description File name for standard surface file, or a constant value, giving the base of the time interval used for wavelet estimation.
   \item \Argument Elements controlling the base surface.
   \item \Default
 \elist
  
\paragraph{\hbracket{time-file}}\rnewkw{time-file}{time-file4}
 \slist
   \item \Description File name for standard surface file giving the base of the time interval used for wavelet estimation. This or \rkw{time-value}{time-value4} must be given.
   \item \Argument File name
   \item \Default
 \elist

\paragraph{\hbracket{time-value}} \rnewkw{time-value}{time-value4}
 \slist
   \item \Description Value giving the base time used the wavelet estimation. This or \rkw{time-file}{time-file3} must be given.
   \item \Argument Value (ms)
   \item \Default
 \elist
...
\subsubsection{\hbracket{file-name}}\rnewkw{file-name}{file-name3}
 \slist
   \item \Description File name for a well file. RMS, Norsar, or LAS format.
   \item \Argument File name
   \item \Default
 \elist
...
\subsubsection{\hbracket{use-for-wavelet-estimation}}\newkw{use-for-wavelet-estimation}
 \slist
   \item \Description Should this well be used for wavelet estimation? This is also used for whether the well should be used for estimate of scale or S/N ratio.
   \item \Argument 'yes' or 'no'
   \item \Default
 \elist
...
\subsubsection{\hbracket{segy-header}}\newkw{segy-header}
 \slist
   \item \Description Repeatable, optional command: Separate segy-header for each background file if they are given in segy-format.
   \item \Default Read from segy file
 \elist
 
\paragraph{\hbracket{parameter}}\newkw{parameter}
 \slist
   \item \Description Reapeatable command: Specifies which background parameters uses the following \rkw{segy-format}{segy-format3}.
   \item \Argument ai, si, vp, vs, vp-vs-ratio or rho/density
   \item \Default
 \elist 
 
\paragraph{\hbracket{segy-format}}\rnewkw{segy-format}{segy-format3}
 \slist
   \item \Description Information about the segy format. By default, CRAVA recognises SeisWorks, IESX, SIP and Charisma. See Table \ref{tab:segyformats}.
   \item \Argument Elements containing information about the segy format
   \item \Default
...
\subparagraph{\hbracket{standard-format}}\rnewkw{standard-format}{standard-format3}
 \slist
   \item \Description Giving the starting format for modifications.
   \item \Argument 'seisworks', 'iesx', 'charisma' or 'SIP'
   \item \Default 'seisworks'
...
\subparagraph{\hbracket{location-x}}\rnewkw{location-x}{location-x3}
 \slist
   \item \Description The byte location for the x-coordinate in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{location-y}}\rnewkw{location-y}{location-y3}
 \slist
   \item \Description The byte location for the y-coordinate in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{location-il}}\rnewkw{location-il}{location-il3}
 \slist
   \item \Description The byte location for the inline in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{location-xl}}\rnewkw{location-xl}{location-xl3}
 \slist
   \item \Description The byte location for the crossline in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{bypass-coordinate-scaling}}\rnewkw{bypass-coordinate-scaling}{bypass-coordinate-scaling3}
 \slist
   \item \Description Indicates whether coordinate scaling information should be used.
   \item \Argument 'yes' or 'no'
   \item \Default
...
\subparagraph{\hbracket{location-scaling-coefficient}}\rnewkw{location-scaling-coefficient}{location-scaling-coefficient3}
 \slist
   \item \Description
   \item \Argument Integer
   \item \Default
...
\subsubsection{\hbracket{segy-header}}\rnewkw{segy-header}{segy-header2}
 \slist
   \item \Description Repeatable, optional command: Separate segy-header for each background file if they are given in segy-format.
   \item \Default Read from segy file
 \elist
 
\paragraph{\hbracket{parameter}}\rnewkw{parameter}{parameter2}
 \slist
   \item \Description Reapeatable command: Specifies which background parameters uses the following \rkw{segy-format}{segy-format3}.
   \item \Argument ai, si, vp, vs, vp-vs-ratio or rho/density
   \item \Default
...
\paragraph{\hbracket{segy-format}}\rnewkw{segy-format}{segy-format4}
 \slist
   \item \Description Information about the segy format. By default, CRAVA recognises SeisWorks, IESX, SIP and Charisma. See Table \ref{tab:segyformats}.
   \item \Argument Elements containing information about the segy format
   \item \Default
...
\subparagraph{\hbracket{standard-format}}\rnewkw{standard-format}{standard-format4}
 \slist
   \item \Description Giving the starting format for modifications.
   \item \Argument 'seisworks', 'iesx', 'charisma' or 'SIP'
   \item \Default 'seisworks'
...
\subparagraph{\hbracket{location-x}}\rnewkw{location-x}{location-x4}
 \slist
   \item \Description The byte location for the x-coordinate in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{location-y}}\rnewkw{location-y}{location-y4}
 \slist
   \item \Description The byte location for the y-coordinate in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{location-il}}\rnewkw{location-il}{location-il4}
 \slist
   \item \Description The byte location for the inline in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{location-xl}}\rnewkw{location-xl}{location-xl4}
 \slist
   \item \Description The byte location for the crossline in the trace header.
   \item \Argument Integer
   \item \Default
...
\subparagraph{\hbracket{bypass-coordinate-scaling}}\rnewkw{bypass-coordinate-scaling}{bypass-coordinate-scaling4}
 \slist
   \item \Description Indicates whether coordinate scaling information should be used.
   \item \Argument 'yes' or 'no'
   \item \Default
...
\subparagraph{\hbracket{location-scaling-coefficient}}\rnewkw{location-scaling-coefficient}{location-scaling-coefficient4}
 \slist
   \item \Description
   \item \Argument Integer
   \item \Default
...
\paragraph{\hbracket{top-surface}}\rnewkw{top-surface}{top-surface4}
 \slist
   \item \Description File name for standard surface file, or a constant value, giving the top of the time interval used for facies estimation.
   \item \Argument Elements controlling the top surface.
   \item \Default
 \elist
  
\subparagraph{\hbracket{time-file}}\rnewkw{time-file}{time-file4}
 \slist
   \item \Description File name for standard surface file giving the top of the time interval used for facies estimation. This or \rkw{time-value}{time-value4} must be given.
   \item \Argument File name
   \item \Default
 \elist

\subparagraph{\hbracket{time-value}}\rnewkw{time-value}{time-value4}
 \slist
   \item \Description Value giving the top time used the facies estimation. This or \rkw{time-file}{time-file4} must be given.
   \item \Argument Value (ms)
   \item \Default
 \elist 

\paragraph{\hbracket{base-surface}}\rnewkw{base-surface}{base-surface4}
 \slist
   \item \Description File name for standard surface file, or a constant value, giving the base of the time interval used for facies estimation.
   \item \Argument Elements controlling the base surface.
   \item \Default
 \elist
  
\subparagraph{\hbracket{time-file}}\rnewkw{time-file}{time-file5}
 \slist
   \item \Description File name for standard surface file giving the base of the time interval used for facies estimation. This or \rkw{time-value}{time-value5} must be given.
   \item \Argument File name
   \item \Default
 \elist

\subparagraph{\hbracket{time-value}} \rnewkw{time-value}{time-value5}
 \slist
   \item \Description Value giving the base time used the facies estimation. This or \rkw{time-file}{time-file5} must be given.
   \item \Argument Value (ms)
   \item \Default
 \elist  
