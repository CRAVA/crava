...
Dry rocks are specified with <dry-rock>, followed by <label> or <use>. If <label> is given, it is followed by a theory for calculating the effective elastic moduli. Then the <total-porosity> and <mineral-bulk-modulus> (i.e. bulk of the effective mineral) are defined. An implicit part of the theories is that the density is calculated using the arithmetic average of the constituents.
   \item \Argument 
   \item \Default 
 \elist
...
\subparagraph{\hbracket{mineral-bulk-modulus}}\newkw{mineral-bulk-modulus}
 \slist
