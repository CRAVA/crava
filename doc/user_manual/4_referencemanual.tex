...
\subsection{\hbracket{temporal-correlation}}\newkw{temporal-correlation}
 ...
 \subsection{\hbracket{temporal-correlation-range}}\newkw{temporal-correlation-range}
  \slist
    \item \Description Parameter for exponential variogram for temporal correlation. Cannot be used in combination with \kw{temporal-correlation} or \kw{parameter-autocovariance}.
    \item \Argument Value
    \item \Default
 \elist
...
\subsection{\hbracket{parameter-correlation}}\newkw{parameter-correlation}
 \slist
   \item \Description File name for the parameter correlation file. The file is an ascii file, containing covariances between Vp, Vs and density. Cannot be used in combination with \kw{parameter-autocovariance}.
