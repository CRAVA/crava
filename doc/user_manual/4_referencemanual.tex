...
\subsubsection{\hbracket{relative-x-coordinate}}\newkw{x-coordinate}
 \slist
   \item \Description Name of the relative x-coordinate log. Can not be given togehter with \kw{x-coordinate} or \kw{y-coordinate}.
   \item \Argument String
   \item \Default
 \elist
...
\subsubsection{\hbracket{relative-y-coordinate}}\newkw{y-coordinate}
 \slist
   \item \Description Name of the relative y-coordinate log.  Can not be given togehter with \kw{x-coordinate} or \kw{y-coordinate}.
   \item \Argument String
   \item \Default
 \elist
...
\subsubsection{\hbracket{log-names}} \rnewkw{log-names}{log-names2}
 \slist
   \item \Description of log headings for this well. Same arguments as for the common \rkw{log-names} above. The name of these logs for this well file are given here.
   \item \Argument Name of logs
