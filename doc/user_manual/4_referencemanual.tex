...
\subparagraph{\hbracket{vintage-number}}\newkw{vintage-number}
 \slist
   \item \Description Unique number of the vintage. Must be given in ascending order, where the first variable given under \kw{variable} has number 1
   \item \Argument Integer value
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{density}}\rnewkw{density}{density-tabulated-fluid}
 \slist
   \item \Description Density. Needs to be specified
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{bulk-modulus}}\rnewkw{bulk-modulus}{bulk-modulus-fluid}
 \slist
   \item \Description Bulk modulus. One of <bulk-modulus> or \rkw{vp}{vp-tabulated-fluid} needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{vp}}\rnewkw{vp}{vp-tabulated-fluid}
 \slist
   \item \Description P-wave velocity. One of \rkw{bulk-modulus}{bulk-modulus-fluid} or <vp> needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{bulk-modulus}}\rnewkw{bulk-modulus}{bulk-modulus-solid}
 \slist
   \item \Description Bulk modulus. One of <bulk-modulus> or \rkw{vp}{vp-tabulated-solid} needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{shear-modulus}}\rnewkw{shear-modulus}{shear-modulus-solid}
 \slist
   \item \Description Shear modulus. One of <shear-modulus> or \rkw{vs}{vs-tabulated-solid} needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{vp}}\rnewkw{vp}{vp-tabulated-solid}
 \slist
   \item \Description P-wave velocity. One of \rkw{bulk-modulus}{bulk-modulus-solid} or <vp> needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{vs}}\rnewkw{vs}{vs-tabulated-solid}
 \slist
   \item \Description S-wave velocity. One of \rkw{shear-modulus}{shear-modulus-solid} or <vs> needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
Dry rocks are specified with <dry-rock>, followed by <label> or <use>. If <label> is given, it is followed by a theory for calculating the effective elastic moduli. Then the <total-porosity> and <mineral-moduli> (i.e. bulk and shear moduli of the effective mineral) are defined. An implicit part of the theories is that the density is calculated using the arithmetic average of the constituents.
   \item \Argument 
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{bulk-modulus}}\rnewkw{bulk-modulus}{bulk-modulus-dry-rock}
 \slist
   \item \Description Bulk modulus. One of <bulk-modulus> or \rkw{vp}{vp-tabulated-dry-rock} needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{shear-modulus}}\rnewkw{shear-modulus}{shear-modulus-dry-rock}
 \slist
   \item \Description Shear modulus. One of <shear-modulus> or \rkw{vs}{vs-tabulated-dry-rock} needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{vp}}\rnewkw{vp}{vp-tabulated-dry-rock}
 \slist
   \item \Description P-wave velocity. One of \rkw{bulk-modulus}{bulk-modulus-dry-rock} or <vp> needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subsubparagraph{\hbracket{vs}}\rnewkw{vs}{vs-tabulated-dry-rock}
 \slist
   \item \Description S-wave velocity. One of \rkw{shear-modulus}{shear-modulus-dry-rock} or <vs> needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subparagraph{\hbracket{total-porosity}}\newkw{total-porosity}
 \slist
...
\subparagraph{\hbracket{mineral-moduli}}\newkw{mineral-moduli}
 \slist
   \item \Description Mineral moduli, i.e., the bulk and shear moduli of the effective mineral of the dry-rock
   \item \Argument Value, trend, distribution or <reservoir-variable>, see \autoref{sec:valueassignment}
   \item \Default 
 \elist

\subsubparagraph{\hbracket{use}}\rnewkw{use}{use-mineral-moduli}
 \slist
   \item \Description The name of the variable giving the mineral moduli
   \item \Argument 
   \item \Default 
 \elist
...
\subparagraph{\hbracket{bulk-modulus}}\newkw{bulk-modulus}
 \slist
   \item \Description Bulk modulus. One of <bulk-modulus> or \rkw{vp}{vp-tabulated-rock} needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subparagraph{\hbracket{shear-modulus}}\newkw{shear-modulus}
 \slist
   \item \Description Shear modulus. One of <shear-modulus> or \rkw{vs}{vs-tabulated-rock} needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subparagraph{\hbracket{vp}}\rnewkw{vp}{vp-tabulated-rock}
 \slist
   \item \Description P-wave velocity. One of \kw{bulk-modulus} or <vp> needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subparagraph{\hbracket{vs}}\rnewkw{vs}{vs-tabulated-rock}
 \slist
   \item \Description S-wave velocity. One of \kw{shear-modulus} or <vs> needs to be specified.
   \item \Argument Value, trend, distribution or variable defined in \kw{reservoir}, see \autoref{sec:valueassignment}
   \item \Default 
 \elist
...
\subparagraph{\hbracket{bulk-modulus-weight}}\newkw{bulk-modulus-weight}
 \slist
   \item \Description The bulk modulus is calculated using the weights and upper/lower bounds from the relation $K=W_k*$upper-bound$+(1-W_k)*$lower-bound. Higher weigths therefore indicate stiffer rock, while lower weights indicate softer rock.
   \item \Argument Value, trend, distribution or <reservoir-variable>, see \autoref{sec:valueassignment}
   \item \Default
 \elist

\subparagraph{\hbracket{p-wave-modulus-weight}}\newkw{p-wave-modulus-weight}
 \slist
   \item \Description The p-wave modulus is often termed $M$, and calculated from the relation $M=\rho*\vp^2$. The p-wave modulus is calculated using the weights and upper/lower bounds from the relation $M=W_m*$upper-bound$+(1-W_m)*$lower-bound. Higher weigths therefore indicate stiffer rock, while lower weights indicate softer rock.
   \item \Argument Value, trend, distribution or <reservoir-variable>, see \autoref{sec:valueassignment}
   \item \Default
 \elist
...
\subparagraph{\hbracket{correlation-weights}}\newkw{correlation-weights}
 \slist
   \item \Description The correlation between the bulk-modulus weight and p-wave-modulus-weight.
   \item \Argument Value
   \item \Default 0
 \elist
...
\subsection{\hbracket{beta}}\newkw{beta}
 \slist
   \item \Description Commands controlling assignment of Beta probabilistic values to a variable. The Beta distribution is defined in the interval [0,1]. Whenever several building blocks use the same stochastic variable defined under \kw{reservoir}, the same sample of the variable is used for all the building blocks. 
   \item \Argument
   \item \Default 
 \elist
...
\subsubsection{\hbracket{mean}}\rnewkw{mean}{mean-beta}
 \slist
   \item \Description Mean value of the Beta distribution on [0,1]
   \item \Argument Value or trend
   \item \Default 
 \elist
...
\subsubsection{\hbracket{variance}}\rnewkw{variance}{variance-beta}
 \slist
   \item \Description Variance of the Beta distribution on [0,1]
   \item \Argument Value or trend
   \item \Default 
 \elist
