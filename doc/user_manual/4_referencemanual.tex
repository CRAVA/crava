...
\subsection{\hbracket{temporal-correlation}}\newkw{temporal-correlation}
 \slist
   \item \Description File name for the temporal correlation file. The file is an ascii file. Usually, this file comes from an earlier run of \crava. Cannot be used in combination with \kw{temporal-correlation-range} or \kw{multiple-intervals}.
   \item \Argument File name
   \item \Default
 \elist
