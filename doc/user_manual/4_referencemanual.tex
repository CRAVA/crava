...
\subparagraph{\hbracket{time-value}} \rnewkw{time-value}{time-value3}
 ...
 \subparagraph{\hbracket{top-surface-erosion-priority} \necessary}\rnewkw{top-surface-erosion-priority}{top-surface-erosion-priority2}
 \slist
...
\subsubparagraph{\hbracket{erosion-priority}} \rnewkw{erosion-priority}{erosion-priority2}
 \slist
...
\subsubsection{\hbracket{locations-file}}\newkw{locations-file}
 \slist
...
\subsubparagraph{\hbracket{probability}}\newkw{interval-probability}
 \slist
...
\subsection{\hbracket{beta-end-mas}}\newkw{beta-end-mass}
 \slist
