...
storm, ASCII Irap or a Multicolumn ASCII format (file with five columns,
x, y, z, IL and XL). Top and base time values for the inversion
...
\item {\bf Surfaces:} The standard format for reading and writing
  ...
  surfaces (formerly known as ASCII Irap classic) and Multicolumn ASCII
  surfaces (file with five columns, x, y, z,  IL and XL). In addition
  some surfaces related to 3D-inversion are read as sgri (NORSAR). On input,
  the surface format will be automatically detected.
