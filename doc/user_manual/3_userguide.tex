...
The standard format for reading and writing
  ...
  surfaces (see example below). In addition
...
with \rkw{top-surface}{top-surface3} and \rkw{base-surface}{base-surface3}. Since these are
