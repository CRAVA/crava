...
\item [New features:] \mbox{ }
  \begin{itemize}
    ...
    \item Build zones for multizone background model. \jira{317}
    \item Fill in values in the multizone background model. \jira{319}
    \item Generate complete multizone background model in timeSimbox. \jira{325}
    \item Include beta distribution in nrlib/random \jira{331}
    \item Include beta distribution with end mass in nrlib/random. \jira{490}
 \end{itemize}
...
\item [Bug fixes:] \mbox{ }
  ...
  \item If ASCII grid output is requested, STORM grids cannot be imported to RMS \jira{224}
    ...
    \item Bug in writing of background trend to file for multizone background model \jira{348}
