...
% -------------------------------------------------
\title{CRAVA User Manual version 0.9.4}
...
\author{P{\aa}l Dahle\and Bj{\o}rn Fjellvoll\and Ragnar Hauge\and Odd Kolbj{\o}rnsen\and Marit Ulvmoen \and Anne-Randi Syversveen}
