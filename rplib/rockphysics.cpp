                                      ...
                                      double                             & rho) const
{
  ...
  bool subst_ok = fluid_subst_->DoSubstitute(rock_, fluid_base, saturation_base, vp_base, vs_base, rho_base, 
...
{
  bool subst_ok = fluid_subst_->DoSubstitute(rock_, fluid_old, saturation_old, vp_old, vs_old, rho_old, 
